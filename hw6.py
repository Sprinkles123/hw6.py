...
def getAdjacencyList(V,E):
    ...
    returnList=[]
    for i in rande (len(V)):
        returnList.append([])
    for j in E:
        k=convertToList(j)
        return[k[0]].append(k[1])
    return returnList
...
if __name__ == '__main__':
    ...
    print('printGraph(*createEmptyGraph(5)):')
    printGraph(*createEmptyGraph(5))
    
    print()
    print('printGraph(*createCompleteGraph(5)):')
    printGraph(*createCompleteGraph(5))
